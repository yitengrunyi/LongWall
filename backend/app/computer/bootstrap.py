...
2. 环境变量 ``LONGWALL_MACOS_HELPER_PATH``；
...
logger = logging.getLogger("longwall.computer.bootstrap")
...
ENV_HELPER_PATH = "LONGWALL_MACOS_HELPER_PATH"
ENV_COMPUTER_ENABLED = "LONGWALL_COMPUTER_ENABLED"
...
def computer_enabled(enabled: bool | None = None) -> bool:
    """Computer 开关：显式参数 > LONGWALL_COMPUTER_ENABLED > 默认启用。
